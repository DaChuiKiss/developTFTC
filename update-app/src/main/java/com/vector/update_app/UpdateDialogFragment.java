...
public class UpdateDialogFragment extends DialogFragment implements View.OnClickListener {
    ...
    //默认色
    private int mDefaultColor = 0xff1E82D2;
    private int mDefaultPicResId = R.mipmap.top_5;
...
//        getDialog().getWindow().addFlags(WindowManager.LayoutParams.FLAG_NOT_TOUCH_MODAL);
    ...
    private void initData() {
        ...
        if (mUpdateApp != null) {
            ...
            //标题
            mTitleTextView.setText(TextUtils.isEmpty(dialogTitle) ? String.format(getString(R.string.The_version_number), newVersion) : dialogTitle);
            //强制更新
