 ...
 */
public class KLine4hFragment extends LazyLoadBaseFragment implements KChartView.KChartRefreshListener {

    @BindView(R.id.kchart_view)
    KChartView mKChartView;

    private KChartAdapter mAdapter;
    LoadingImgDialog loadingImgDialog;
...
//    List<KLineEntity> data;
    ...
    boolean isObject;
    public void kilineSocket4h(){
       disposable= SocketClient.getInstance().topicKLineInfo(((KLineTradeActivity)getActivity()).getMarketId(),4*60*60*1000,  new SocketClient.OnSocketReceivedListener(){
            @Override
            public void onReceive(String response) {
               // ToastUtils.showLong(App.getContext(), response);
                ...
                try {
                    ...
                    if (obj.has("data")) {
                        isObject=false;
                        mCache.put("kline4h"+((KLineTradeActivity)getActivity()).getMarketId(),response);
                    ...
                    getActivity().runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            mAdapter.addFooterData(data,isObject,loadingImgDialog);
            ...
            public void onError(Throwable throwable) {
                if(loadingImgDialog!=null&&loadingImgDialog.isShowing())
    ...
    public void getCacheValue(){
        ...
        String response =  mCache.getAsString("kline4h"+((KLineTradeActivity)getActivity()).getMarketId());
        if(response==null) {
            loadingImgDialog = new LoadingImgDialog(getContext(), R.mipmap.loading);
