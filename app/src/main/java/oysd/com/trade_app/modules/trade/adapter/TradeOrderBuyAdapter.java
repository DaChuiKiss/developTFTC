...
public class TradeOrderBuyAdapter extends BaseAdapter<SocketOrder.BuyEntrustListBean> {


    public TradeOrderBuyAdapter(@NonNull Context context, @NonNull int layoutId) {
        super(context, layoutId);
    }

    public TradeOrderBuyAdapter(@NonNull Context context, int layoutId,
