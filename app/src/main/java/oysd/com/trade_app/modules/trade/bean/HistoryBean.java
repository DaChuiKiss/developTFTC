...
public class HistoryBean {
    ...
    public BigDecimal getAvgReachedPrice() {
        return avgReachedPrice;
    }

    public void setAvgReachedPrice(BigDecimal avgReachedPrice) {
        this.avgReachedPrice = avgReachedPrice;
    }
     ...
     * unReachCount : 0
     */
    private BigDecimal avgReachedPrice;
    private String billPair;
    private String createDate;
    private BigDecimal entrustCount;
    private BigDecimal entrustPrice;
    private BigDecimal entrustStatus;
    private int id;
    ...
    public BigDecimal getEntrustStatus() {
        return entrustStatus;
    }

    public void setEntrustStatus(BigDecimal entrustStatus) {
