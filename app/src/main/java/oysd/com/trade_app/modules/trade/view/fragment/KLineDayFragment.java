 ...
 */
public class KLineDayFragment extends LazyLoadBaseFragment implements KChartView.KChartRefreshListener {
    ...
    boolean isObject;
    public void kilineSocketDay(){
       disposable = SocketClient.getInstance().topicKLineInfo(((KLineTradeActivity)getActivity()).getMarketId(),24*60*60*1000,  new SocketClient.OnSocketReceivedListener(){
            @Override
            public void onReceive(String response) {
              //  ToastUtils.showLong(App.getContext(), response);
                ...
                try {
                    ...
                    if (obj.has("data")) {
                        isObject=false;
                        mCache.put("kline1day"+((KLineTradeActivity)getActivity()).getMarketId(),response);
    ...
    public void getCacheValue(){
        ...
        String response =  mCache.getAsString("kline1day"+((KLineTradeActivity)getActivity()).getMarketId());
        if(response==null) {
