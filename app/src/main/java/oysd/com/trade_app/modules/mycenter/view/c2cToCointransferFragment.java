...
public class c2cToCointransferFragment extends BaseToolActivity implements MyAccountTransferContract.View{
    ...
    protected int setView() {
        return R.layout.transfer_layout_c2c;
    }
    @Override
    protected void initView() {
        super.initView();
        ltb =this.getIntent().getParcelableExtra("LegalOTCBean");
        setTitleText(R.string.c2cToCoin);
        tv_transferOTC_useable.setText(Utils.myAccountFormat(ltb.getAvailableAmount()));
        tv_transferOTC_freeze.setText(Utils.myAccountFormat(ltb.getFrozenAmount()));
        tv_transferOTC_total.setText(Utils.myAccountFormat(ltb.getAvailableAmount().add(ltb.getFrozenAmount())));
    ...
    public void c2cTransferAccountsSuccess(EmptyBean tb) {
        ...
        c2cToCointransferFragment.this.finish();
    }
