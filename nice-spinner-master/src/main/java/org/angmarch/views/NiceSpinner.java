...
public class NiceSpinner extends AppCompatTextView {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        setPadding(resources.getDimensionPixelSize(R.dimen.three_grid_unit), defaultPadding, resources.getDimensionPixelSize(R.dimen.three_grid_unit),
                defaultPadding);
        setClickable(true);

        background =typedArray.getResourceId(R.styleable.NiceSpinner_backgroundSelector, R.drawable.rectangle_grey);
        backgroundSelector = typedArray.getResourceId(R.styleable.NiceSpinner_backgroundSelector, R.drawable.rect_black);
        setBackgroundResource(background);
        textColor = context.getResources().getColor(R.color.text_normal);
    ...
    private int getDefaultTextColor(Context context) {
        ...
        int defaultTextColor = typedArray.getColor(0, Color.WHITE);
        typedArray.recycle();
