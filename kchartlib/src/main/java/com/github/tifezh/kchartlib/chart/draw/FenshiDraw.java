...
public class FenshiDraw implements IChartDraw<ICandle>{
    ...
    public FenshiDraw(BaseKChartView view) {
        Context context=view.getContext();
        mContext=context;
        mBluePaint.setColor(ContextCompat.getColor(context,R.color.chart_text));
    ...
    public void drawTranslated(@Nullable ICandle lastPoint, @NonNull ICandle curPoint, float lastX, float curX, @NonNull Canvas canvas, @NonNull BaseKChartView view, int position) {
        ...
        //画分时图
        view.drawMainLine(canvas, mBluePaint, lastX, lastPoint.getClosePrice(), curX, curPoint.getClosePrice());
...
//                canvas.drawLine(x, high, x, open, mRedPaint);
//                canvas.drawLine(x, close, x, low, mRedPaint);
//                canvas.drawLine(x - r + lineR,close , x - r + lineR, open, mRedPaint);
//                canvas.drawLine(x + r - lineR,close, x + r - lineR, open, mRedPaint);
...
//        } else {
//            canvas.drawRect(x - r, close + 1, x + r,open , mRedPaint);
//            canvas.drawRect(x - lineR, high, x + lineR, low, mRedPaint);
//        }
//    }
...
//    }
    ...
    public void setLineWidth(float width)
    {
        ...
        mBluePaint.setStrokeWidth(width);
    }
