...
import com.github.tifezh.kchartlib.chart.draw.FenshiDraw;

/**
 * k线图
 * Created by tian on 2016/5/20.
 */
public class MinuteChartView extends BaseKChartView {
    ...
    private void initAttrs(AttributeSet attrs) {
        ...
        if(array!=null)
        {
            try {
                ...
                setCandleSolid(true);
                //tab
                mKChartTabView.setIndicatorColor(getColor(R.color.colorPrimaryDark));
...
//    }
    ...
    public void setSelectorTextSize(float textSize){
        fenshiDraw.setSelectorTextSize(textSize);
    }
    ...
    public void setSelectorBackgroundColor(int color) {
        fenshiDraw.setSelectorBackgroundColor(color);
    }
    ...
    public void setCandleWidth(float candleWidth) {
        fenshiDraw.setCandleWidth(candleWidth);
    }
    ...
    public void setCandleLineWidth(float candleLineWidth) {
        fenshiDraw.setCandleLineWidth(candleLineWidth);
    }
    ...
    public void setCandleSolid(boolean candleSolid) {
        fenshiDraw.setCandleSolid(candleSolid);
    }
    ...
    public void setTextSize(float textSize) {
        ...
        fenshiDraw.setTextSize(textSize);
    ...
    public void setLineWidth(float lineWidth) {
        ...
        fenshiDraw.setLineWidth(lineWidth);
        mBOLLDraw.setLineWidth(lineWidth/2);
        mRSIDraw.setLineWidth(lineWidth/2);
        mMACDDraw.setLineWidth(lineWidth/2);
        mKDJDraw.setLineWidth(lineWidth/2);
        mVolumeDraw.setLineWidth(lineWidth/2);
    }

    @Override
    public void setTextColor(int color) {
        super.setTextColor(color);
        fenshiDraw.setSelectorTextColor(color);
    }
