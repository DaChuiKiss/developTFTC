...
public abstract class BaseKChartView extends ScrollAndScaleView {
    ...
    private void initRect(int w,int h)
    {
        ...
        int mMainHeight = (int) (displayHeight * 0.66f);
        int mChildHeight = (int) (displayHeight * 0.34f);
    ...
    public float getMainY(float value) {
        return  (float)((mMainMaxValue - value) * mMainScaleY+mMainRect.top);
    }

    public float getChildY(float value) {
        return  (float)((mChildMaxValue - value) * mChildScaleY + mChildRect.top);
    }
    ...
    private void calculateValue() {
        ...
        if(mMainMaxValue!=mMainMinValue) {
            float padding = (float)(mMainMaxValue - mMainMinValue) * 0.05f;
        ...
        mMainScaleY =  (float)(mMainRect.height() * 1f / (mMainMaxValue - mMainMinValue));
        mChildScaleY = (float)(mChildRect.height() * 1f / (mChildMaxValue - mChildMinValue));
